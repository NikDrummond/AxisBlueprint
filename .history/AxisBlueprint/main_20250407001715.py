...
try:
    ...
    raise ImportError("Tkinter is required to run AxisBlueprint. Please install it via your OS package manager.")

try:
    import ipywidgets as widgets
except ImportError:
    raise ImportError("ipywidgets is required. Please install it via pip: pip install ipywidgets")
